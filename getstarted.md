...
### Overview of steps required (The easy way)
...
by clicking the Fork button on the top right corner in GitHub. Forking means that you now copied this entire project and all the files into your account.
